...
class NEBInventoryItemLookupIntentHandler extends IntentBaseManager {
  ...
  getResponsePrompt() {
    return new Promise((resolve, reject) => {
      console.log(`[NEBInventoryItemLookup IntentHandler] Getting Response Prompt`);
...
export default NEBInventoryItemLookupIntentHandler;
