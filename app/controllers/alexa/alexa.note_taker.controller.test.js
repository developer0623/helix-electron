...
describe('Alexa Note Taker Controller', () => {
  beforeEach((done) => {
    createDB(() => {
  ...
  describe('Taking a Note', () => {
    const intent = "RecordNoteIntent";

    const expectedSSML = '<speak>Ok, I\'ll start recording.</speak>';
    const expectedOutput = {
      type: "SSML",
      ssml: expectedSSML
    }

    it('should ask from prompt when I start a note', (done) => {
      const payload =  {
        "type": "IntentRequest",
