...
describe('Alexa Help Controller', () => {
  beforeEach((done) => {
    createDB(() => {
  ...
  describe('Help Intent', () => {
    it('should return a Help prompt', (done) => {
      const expectedOutput = {
        type: "SSML",
        ssml: "<speak>Hi. I\'m Helix. I can look up scientific reference data for you. Or you can ask me about a solution or protocol.</speak>"
      }
      const payload = {
        "type": "IntentRequest",
