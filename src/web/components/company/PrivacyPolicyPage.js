        ...
        <div id="privacy-policy" className="container">
         <h2>Privacy Policy</h2>
          <p>This privacy policy has been compiled to better serve those who are concerned with how their 'Personally
             ...
             described in US privacy law and information security, is
             information that can be used on its own or with other
             information to identify, contact, or locate a single person, or
             to identify an individual in context. Please read our privacy
            ...
            <h3>What
               personal information do we collect from the people that visit
               our blog, website or app?</h3>
            ...
            <p>We collect information from you when you fill out a form or enter
               information on our site.</p>
            <h3>How do we use your information?</h3>
            <p>We may use the information we collect from
            ...
            <p>We implement a variety of security
               measures when a user enters, submits, or accesses their
            ...
            <p>Yes. Cookies are small files that a
               ...
               use cookies to help us remember and process the items in your
            ...
            <p>You can
               ...
               being sent, or you can choose to turn off all cookies. You do
            ...
            <p>We do not
               ...
               others' rights, property or safety.</p>
            <p>However,
            ...
            <p>Occasionally, at our discretion, we may
            ...
            <h3>Google</h3>
            <p>Google's advertising requirements can be
            ...
            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               <strong>&bull;</strong> Remarketing with Google AdSense
            </p>
            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               <strong>&bull;</strong> Google Display Network Impression
               Reporting
            </p>
            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <p>We, along with
               third-party vendors such as Google use first-party cookies (such
               as the Google Analytics cookies) and third-party cookies (such
               as the DoubleClick cookie) or other third-party identifiers
            ...
            <h3>Opting out:</h3>
            <p>Users can set preferences for how Google
            ...
            <p
               className="blueText"><strong>California Online Privacy Protection
               Act</strong>
            </p>
            <p>CalOPPA is the
            ...
            <h3>According to
               CalOPPA, we agree to the following:</h3>
            <p>Users can visit our site anonymously.</p>
            <p>Once this privacy
               policy is created, we will add a link to it on our home page or
               as a minimum, on the first significant page after entering our
               website.
            </p>
            <p>Our Privacy Policy
            ...
            <p>Can change your personal
               information:
            </p>
            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               <strong>&bull;</strong> By emailing us
            </p>
            <h3>How does our site handle Do Not
               Track signals?</h3>
            <p>We
               honor Do Not Track signals and Do Not Track, plant cookies, or
               use advertising when a Do Not Track (DNT) browser mechanism is
               in place.
            </p>
            ...
            <p className="blueText"><strong>COPPA
               (Children Online Privacy Protection Act)</strong>
            </p>
            <p>When it comes to the collection of
            ...
            <p>The Fair Information Practices Principles form
               the backbone of privacy law in the United States and the
            ...
            <h3>In order to be in line
               with Fair Information Practices we will take the following
               responsive action, should a data breach
               occur:</h3>
            <p>We will notify you via email</p>
            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               <strong>&bull;</strong> Within 7 business days
            </p>
            <p>We will notify the users via in-site
               notification
            </p>
            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               <strong>&bull;</strong> Within 7 business days
            </p>
            <p>We also agree to the Individual Redress
            ...
            <h3 className="blueText">CAN SPAM Act</h3>
            <p>The CAN-SPAM Act
               is a law that sets the rules for commercial email, establishes
               requirements for commercial messages, gives recipients the right
               to have emails stopped from being sent to them, and spells out
               tough penalties for violations.</p>
            <p><strong>We collect your email address in order
               to:</strong>
            </p>
            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               <strong>&bull;</strong> Send information, respond to inquiries,
               and/or other requests or questions
            </p>
            <p><strong>To be in accordance with
               CANSPAM, we agree to the following:</strong>
            </p>
            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               <strong>&bull;</strong> Not use false or misleading subjects or
               email addresses.
            </p>
            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               <strong>&bull;</strong> Identify the message as an advertisement
               in some reasonable way.
            </p>
            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               <strong>&bull;</strong> Include the physical address of our
               business or site headquarters.
            </p>
            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               <strong>&bull;</strong> Monitor third-party email marketing
               services for compliance, if one is used.
            </p>
            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               <strong>&bull;</strong> Honor opt-out/unsubscribe requests
               quickly.
            </p>
            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               <strong>&bull;</strong> Allow users to unsubscribe by using the
               link at the bottom of each email.
            </p>
            <p>If at any time you would like to
               unsubscribe from receiving future emails, you can email us
               at</p>
            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               <strong>&bull;</strong> Follow the instructions at the bottom of
               each email
            and we will promptly remove you from
            <strong>ALL</strong> correspondence.</p>
         <h3 className="blueText">Contacting Us</h3>
         <p>If there are any questions regarding this
            privacy policy, you may contact us using the information
            below.</p>
        <address>
         <strong>HelixAI</strong><br />
         829 Weir St.<br />
         Charleston, South Carolina (SC) 29412<br />
         United States
        </address>
        <address>
         <a href="mailto: hello@askhelix.io">hello@askhelix.io</a>
        </address>
        <p>Last Edited on 2017-07-01</p>
