...
const EntityListRow = ({companyId, type, dataSetId, repositoryId, entity, onDeleteButtonClick}) => {
  function onDelete(e) {
  ...
  return (
    <tr>
      <td><Link to={`/admin/repositories/${repositoryId}/entities/${entity._id}`}>{entity.name}</Link></td>
      <td>{entity.say_as}</td>
