...
const InventoryGridItemTemplate = ({repository, onSelectClick, onDeleteButtonClick}) => {
  function onSelect(e) {
  ...
  return (
    <div className="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-3">
      <Link to={`/admin/inventories/${repository._id}/entities`} className="item">
        <div className="well">
