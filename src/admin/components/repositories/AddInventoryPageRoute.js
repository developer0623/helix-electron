...
import InventoryFlowRoute from './Flows/InventoryFlowRoute';
...
class AddInventoryPage extends React.Component {
  ...
  onComplete(event) {
    event.preventDefault();
    this.context.router.history.push(`/admin/inventories`);
  }
...
export default connect(mapStateToProps, mapDispatchToProps)(AddInventoryPage);
