...
class ManageLabPage extends React.Component {
    ...
    return (
      ...
      {this.props.lab._id ?
          ...
          <LabForm
            ...
            laboratoryProfiles={this.props.laboratoryProfiles}
...
ManageLabPage.propTypes = {
  company: PropTypes.object.isRequired,
  lab: PropTypes.object.isRequired,
  skillGroups: PropTypes.array.isRequired,
  laboratoryProfiles: PropTypes.array.isRequired,
  actions: PropTypes.object.isRequired,
  loading: PropTypes.bool.isRequired
};
ManageLabPage.contextTypes = {
...
function mapStateToProps(state, ownProps) {
  ...
  return {
    ...
    lab: lab,
    laboratoryProfiles: state.laboratoryProfiles,
...
export default connect(mapStateToProps, mapDispatchToProps)(ManageLabPage);
